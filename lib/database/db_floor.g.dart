    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Book` (`id` TEXT NOT NULL, `page` INTEGER NOT NULL, `title` TEXT NOT NULL, `description` TEXT, `imageSrc` TEXT, PRIMARY KEY (`id`))');
...
class _$BookDao extends BookDao {
  ...
  @override
  Future<List<Book>> findAllBook() async {
  ...
  @override
  Future<void> insertBook(Book person) async {
    await _bookInsertionAdapter.insert(person, OnConflictStrategy.abort);
  }
